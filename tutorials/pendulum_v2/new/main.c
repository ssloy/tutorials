...
//#define FD
    ...
    while (1) {
        ...
        if (1==state) {
            ...
            float diffQ = hatDQ + 80*(mesQ - hatQ);
            float diffLPX = 373.066*(mesX - hatX) + .933*u + (4604.916*cosQ*(hatQ - mesQ)) * A;
...
#elif defined SMO
          float A = 1./(cosQ*cosQ - 4.803); // soft
          float diffDX = 11.0*sgn(mesX - hatX) - (4.178*u + .449*hatDQ*hatDQ*sinQ -   9.810*cosQ*sinQ) * A; // soft
          float diffDQ = 31.9*sgn(mesQ - hatQ) + (9.295*u*cosQ - 104.828*sinQ + hatDQ*hatDQ*cosQ*sinQ) * A; // soft
          float diffX = hatDX + 4.7434*sgn(mesX - hatX)*sqrt(fabsf(hatX - mesX)); // soft
          float diffQ = hatDQ + 8.0777*sgn(mesQ - hatQ)*sqrt(fabsf(hatQ - mesQ)); // soft

//            float A = 1./(cosQ*cosQ - 4.803); // hard
//            float diffDX = 30.8*sgn(mesX - hatX) - (4.178*u + .449*hatDQ*hatDQ*sinQ -   9.810*cosQ*sinQ) * A; // hard
//            float diffDQ = 85.8*sgn(mesQ - hatQ) + (9.295*u*cosQ - 104.828*sinQ + hatDQ*hatDQ*cosQ*sinQ) * A; // hard
//            float diffX = hatDX +  7.937*sgn(mesX - hatX)*sqrt(fabsf(hatX - mesX)); // hard
//            float diffQ = hatDQ + 13.248*sgn(mesQ - hatQ)*sqrt(fabsf(hatQ - mesQ)); // hard
...
#elif defined HGO6
//          float A = 1./(cosQ*cosQ - 4.803); // soft
//          float diffDX = hatSigmaX + 8000.0*(mesX - hatX) - (4.178*u + .449*hatDQ*hatDQ*sinQ - 9.810*cosQ*sinQ  ) * A; // soft
//          float diffDQ = hatSigmaQ + 8000.0*(mesQ - hatQ) + (9.295*u*cosQ - 104.828*sinQ + hatDQ*hatDQ*cosQ*sinQ) * A; // soft
//          float diffX = hatDX + 200.0*(mesX - hatX); // soft
//          float diffQ = hatDQ + 200.0*(mesQ - hatQ); // soft
//          float diffSigmaX = 256000.0*(mesX - hatX); // soft
//          float diffSigmaQ = 256000.0*(mesQ - hatQ); // soft

            float A = 1./(cosQ*cosQ - 4.803); // hard
            float diffDX = hatSigmaX + 29585.799*(mesX - hatX) - (4.178*u + .449*hatDQ*hatDQ*sinQ - 9.810*cosQ*sinQ  ) * A; // hard
            float diffDQ = hatSigmaQ + 29585.799*(mesQ - hatQ) + (9.295*u*cosQ - 104.828*sinQ + hatDQ*hatDQ*cosQ*sinQ) * A; // hard
            float diffX = hatDX + 384.615*(mesX - hatX);  // hard
            float diffQ = hatDQ + 384.615*(mesQ - hatQ);  // hard
            float diffSigmaX = 1820664.543*(mesX - hatX); // hard
            float diffSigmaQ = 1820664.543*(mesQ - hatQ); // hard
...
//    chirp_current_open_loop(2500, 2000L, 9000L, 5L*1000L, &uart_stream);
    constant_current_open_loop(-1000, 4L*1000L, &uart_stream);
