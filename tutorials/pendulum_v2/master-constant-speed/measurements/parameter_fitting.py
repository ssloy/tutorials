...
runs = []
#runs = runs + ["chirp-1.6A-5s-2Hz-9Hz/a_si.csv"]
#runs = runs + ["chirp-1.6A-5s-2Hz-9Hz/b_si.csv"]
#runs = runs + ["chirp-1.6A-5s-2Hz-9Hz/c_si.csv"]
#runs = runs + ["chirp-2A-5s-2Hz-9Hz/a_si.csv"]
#runs = runs + ["chirp-2A-5s-2Hz-9Hz/b_si.csv"]
#runs = runs + ["square-wave/1Hz-.4A_si.csv"]
#runs = runs + ["square-wave/square-wave-2Hz-1A_si.csv"]
#runs = runs + ["square-wave/3Hz-1.2A_si.csv"]
#runs = runs + ["rand/rand_a_si.csv"]
#runs = runs + ["rand/rand_b_si.csv"]
#runs = runs + ["rand/rand_c_si.csv"]
#runs = runs + ["current_regulator_dampened/chirp-2A-5s-1Hz-5Hz-a-si.csv"]
#runs = runs + ["current_regulator_dampened/chirp-2.5A-5s-2Hz-9Hz-a-si.csv"]
runs = runs + ["current_regulator_dampened/stabilization-30s-si.csv"]
#runs = runs + ["current_regulator_dampened/square-wave-2Hz-1A-a-si.csv"]
#runs = runs + ["current_regulator_dampened/rand-c-si.csv"]
